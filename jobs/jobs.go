...
func PriceDiscoveryHumanBehaviour(folder string) error {
	...
	if err != nil {
		...
		err := bm.GatherData(chain.Blockchain(), chain.HandleCreator(), 880_000, 8_888)
		if err != nil {
			return err
		}
	...
	err = bp.AnalyzeDataDetermineChange(chain.Blockchain(), chain.HandleCreator(), bm, 880_000, 8_888)
	if err != nil {
		return err
	}
